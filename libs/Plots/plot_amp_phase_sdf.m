...
%
% Notes:
%   - This code is an adaptation of the following codes:
...
%       Overview and numerical results," Radio Sci., 51, 789–813.
...
%   Email: rdlfresearch@gmail.com
    ...
    [Imu, muAxis, theoretical_s4_val] = Ispectrum(irr_params.U, irr_params.p1, irr_params.p2, irr_params.mu0);
    ...
    xlabel('Frequency (Hz)');
    ylabel('SDF (dB)');
    title(sprintf('Post-Prop Intensity vs. Theoretical (Theoretical S4=%.5f; Experimental S4 = %.5f)', theoretical_s4_val, experimental_s4_val));
