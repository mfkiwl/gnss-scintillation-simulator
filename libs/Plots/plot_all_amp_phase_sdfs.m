...
%
%   The intensity SDF of the post-propagation scintillation field is 
...
%   Email: rdlfresearch@gmail.com
    ...
    for i = 1:numel(scenarios)
        ...
        for j = 1:numel(frequencies)
            ...
            title(sprintf('%s %s | S_4: Th. %.3f, Exp. %.3f', scenario, freq, theoretical_s4_val, experimental_s4_val), 'FontSize', 10, 'FontName', 'Helvetica');
